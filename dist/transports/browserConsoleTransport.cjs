...
const createBrowserConsoleTransport = ({ levelColors = {}, }) => {
    // Cache the CSS used for each level
    let levelCssCache = new Map();
...
exports.createBrowserConsoleTransport = createBrowserConsoleTransport;
//# sourceMappingURL=browserConsoleTransport.cjs.map
